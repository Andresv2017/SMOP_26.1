...
/**
 * Kriftognathus chick — a genuinely different skeleton from the adult, not a scaled copy: it has no
 * separate claw or calf bones, and its bone names are unprefixed where the adult's carry a {@code g}.
 * That is why the entity picks its clip definition by age through a supplier rather than sharing one
 * set: baking an adult clip against this model would throw on the first missing bone.
 */
public class KriftoBabyModel extends EntityModel<DeluxeEntityRenderState> {
    ...
    public static LayerDefinition createBodyLayer() {
        ...
        PartDefinition head = neck.addOrReplaceChild("head", CubeListBuilder.create().texOffs(28, 0).addBox(1.0F, -4.0F, -3.0F, 0.0F, 2.0F, 3.0F, new CubeDeformation(0.0F))
                .texOffs(8, 27).addBox(-0.5F, -2.0F, -1.0F, 3.0F, 3.0F, 1.0F, new CubeDeformation(0.0F))
                .texOffs(0, 25).addBox(0.0F, -2.0F, -6.0F, 2.0F, 2.0F, 2.0F, new CubeDeformation(0.0F))
                .texOffs(28, 22).addBox(0.0F, 0.0F, -6.0F, 2.0F, 1.0F, 1.0F, new CubeDeformation(0.01F))
                .texOffs(16, 0).addBox(-0.5F, -2.0F, -4.0F, 3.0F, 2.0F, 3.0F, new CubeDeformation(0.0F)), PartPose.offset(-1.0F, -3.0F, -1.0F));

        PartDefinition cube_r1 = head.addOrReplaceChild("cube_r1", CubeListBuilder.create().texOffs(18, 17).addBox(-1.5F, -2.0F, 0.0F, 3.0F, 2.0F, 3.0F, new CubeDeformation(0.0F)), PartPose.offsetAndRotation(1.0F, -2.0F, -4.0F, -0.2618F, 0.0F, 0.0F));

        PartDefinition eyes = head.addOrReplaceChild("eyes", CubeListBuilder.create().texOffs(18, 12).addBox(-0.5F, -1.0F, -1.5F, 3.0F, 2.0F, 3.0F, new CubeDeformation(0.01F)), PartPose.offset(0.0F, -1.0F, -2.5F));
        ...
        PartDefinition lower_jaw = head.addOrReplaceChild("lower_jaw", CubeListBuilder.create().texOffs(0, 21).addBox(-1.5F, 0.0F, -3.0F, 3.0F, 1.0F, 3.0F, new CubeDeformation(0.0F))
                ...
                .texOffs(0, 21).mirror().addBox(-1.5F, 0.0F, -3.0F, 3.0F, 1.0F, 3.0F, new CubeDeformation(0.0F)).mirror(false), PartPose.offset(1.0F, 0.0F, -1.0F));
