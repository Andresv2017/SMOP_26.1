...
/**
 * Adult Nirasmosaurus, a marine reptile. Geometry is the untouched 1.20.1 Blockbench export; the
 * port is in {@code setupAnim}, which no longer hand-drives a pile of {@code AnimationState}s — the
 * {@link Rig} resets the pose, blends whatever the {@code MobAnimator} says is playing, and layers
 * head tracking on top, the same shape every other SMOP mob uses.
 *
